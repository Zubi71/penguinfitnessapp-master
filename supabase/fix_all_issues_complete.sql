-- Complete fix for all client access issues
...
-- 15. Create a function to get client by email (for debugging)
...
-- 16. Check if there are any exercises with YouTube URLs
SELECT 
