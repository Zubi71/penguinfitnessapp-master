...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_workout_days_cycle_id ON workout_days(cycle_id);
CREATE INDEX IF NOT EXISTS idx_workout_days_week_day ON workout_days(week_number, day_number);
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_body_weight_client_id ON body_weight_tracker(client_id);
CREATE INDEX IF NOT EXISTS idx_body_weight_trainer_id ON body_weight_tracker(trainer_id);
CREATE INDEX IF NOT EXISTS idx_body_weight_date ON body_weight_tracker(date);
